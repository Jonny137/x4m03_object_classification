...
normfilePath = currentPath + '\\normRecordedData\\'

# Folder and file related variables
recList = os.listdir('recordedData')
modList = os.listdir('normRecordedData')
dataFolder = 'recordedData/'
labelFolder = 'normLabeledData/'
modifiedFolder = 'normRecordedData/'
uniqueFiles = []
fileSet = []
...
def append_class_label():
    ...
    for filename in modList:
        try:
            readLoc = 'normRecordedData/' + filename
